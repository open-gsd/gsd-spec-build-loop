...
function passPrompt(lane) {
  return `Use $gsd-loop-${lane}. Execute exactly one pass. Your final response must end with one line in this exact form: GSD_LOOP_RESULT={"lane":"${lane}","status":"STATUS","reason":"short-reason"} where STATUS is one of work, idle, or blocked`;
}
